...
@router.get("/{symbol}")
def analyze_symbol(symbol: str, timeframe: str = "15m", account_size: float = Query(default=10000.0, ge=100.0), risk_percent: float = Query(default=1.0, ge=0.1, le=10.0)) -> dict:
